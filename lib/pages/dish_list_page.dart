...
class DishListPage extends StatelessWidget {
  ...
  Future<List<dynamic>> _fetchDishes() async {
    try {
      final response = await _dio.get('https://your-api-url.com/dishes'); // Remplacez cette URL par celle de votre API
      if (response.statusCode == 200) {
        return response.data; // Assurez-vous que la réponse est une liste de plats
      } else {
      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            ...
            onPressed: () async {
              await _dio.delete('https://your-api-url.com/dishes/$dishId'); // Remplacez l'URL par votre API de suppression
